...
async def test_read_tables_actionprofile(demonet, caplog):
    ...
    expected_switch_states = {
        "127.0.0.1:50001": {
            ...
            "srv6_my_sid NoAction()",
            "srv6_transit NoAction()",
            "P4ActionProfileGroup(action_profile_id='ecmp_selector', group_id=1, max_size=0, members=[P4Member(member_id=1, weight=1), P4Member(member_id=2, weight=1)])",
            "P4ActionProfileMember(action_profile_id='ecmp_selector', member_id=1, action=P4TableAction(name='set_next_hop', args={'dmac': 803158884353}))",
            "P4ActionProfileMember(action_profile_id='ecmp_selector', member_id=2, action=P4TableAction(name='set_next_hop', args={'dmac': 803158884354}))",
            "P4ActionProfileMember(action_profile_id='ecmp_selector', member_id=65537, action=P4TableAction(name='set_next_hop', args={'dmac': 26}))",
        },
        "127.0.0.1:50002": {
            "acl_table 0x1 ingress_port=* dst_addr=* src_addr=* ether_type=0x806 ip_proto=* icmp_type=* l4_src_port=* l4_dst_port=* clone_to_cpu()",
            "acl_table 0x1 ingress_port=* dst_addr=* src_addr=* ether_type=0x86dd ip_proto=0x3a icmp_type=0x87 l4_src_port=* l4_dst_port=* clone_to_cpu()",
            ...
            "P4ActionProfileMember(action_profile_id='ecmp_selector', member_id=1, action=P4TableAction(name='set_next_hop', args={'dmac': 803158884353}))",
            "P4ActionProfileMember(action_profile_id='ecmp_selector', member_id=2, action=P4TableAction(name='set_next_hop', args={'dmac': 803158884354}))",
            "P4ActionProfileMember(action_profile_id='ecmp_selector', member_id=65537, action=P4TableAction(name='set_next_hop', args={'dmac': 48}))",
        },
        "127.0.0.1:50003": {
            "acl_table 0x2 ingress_port=* dst_addr=* src_addr=* ether_type=0x88cc ip_proto=* icmp_type=* l4_src_port=* l4_dst_port=* send_to_cpu()",
            "acl_table NoAction()",
            ...
            "srv6_my_sid NoAction()",
            "srv6_transit NoAction()",
            "P4ActionProfileMember(action_profile_id='ecmp_selector', member_id=1, action=P4TableAction(name='set_next_hop', args={'dmac': 730144440321}))",
            "P4ActionProfileMember(action_profile_id='ecmp_selector', member_id=2, action=P4TableAction(name='set_next_hop', args={'dmac': 730144440322}))",
        },
        "127.0.0.1:50004": {
            "acl_table 0x2 ingress_port=* dst_addr=* src_addr=* ether_type=0x88cc ip_proto=* icmp_type=* l4_src_port=* l4_dst_port=* send_to_cpu()",
            "acl_table NoAction()",
