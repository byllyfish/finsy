...
async def test_read_tables(demonet, caplog):
    ...
    expected_switch_states = {
        "127.0.0.1:50001": {
            "acl_table ingress_port=* dst_addr=* src_addr=* ether_type=0x806 ip_proto=* icmp_type=* l4_src_port=* l4_dst_port=* clone_to_cpu()",
            "acl_table ingress_port=* dst_addr=* src_addr=* ether_type=0x86dd ip_proto=0x3a icmp_type=0x87 l4_src_port=* l4_dst_port=* clone_to_cpu()",
            "acl_table ingress_port=* dst_addr=* src_addr=* ether_type=0x86dd ip_proto=0x3a icmp_type=0x88 l4_src_port=* l4_dst_port=* clone_to_cpu()",
            "acl_table ingress_port=* dst_addr=* src_addr=* ether_type=0x88cc ip_proto=* icmp_type=* l4_src_port=* l4_dst_port=* send_to_cpu()",
            ...
            "l2_ternary_table dst_addr=0x333300000000/16 set_multicast_group(gid=0x63)",
            "l2_ternary_table dst_addr=0xffffffffffff set_multicast_group(gid=0x63)",
