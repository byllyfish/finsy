...
class Entity(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        extern_entry: typing.Optional[global___ExternEntry] = ...,
        table_entry: typing.Optional[global___TableEntry] = ...,
        action_profile_member: typing.Optional[global___ActionProfileMember] = ...,
        action_profile_group: typing.Optional[global___ActionProfileGroup] = ...,
        meter_entry: typing.Optional[global___MeterEntry] = ...,
        direct_meter_entry: typing.Optional[global___DirectMeterEntry] = ...,
        counter_entry: typing.Optional[global___CounterEntry] = ...,
        direct_counter_entry: typing.Optional[global___DirectCounterEntry] = ...,
        packet_replication_engine_entry: typing.Optional[global___PacketReplicationEngineEntry] = ...,
        value_set_entry: typing.Optional[global___ValueSetEntry] = ...,
        register_entry: typing.Optional[global___RegisterEntry] = ...,
        digest_entry: typing.Optional[global___DigestEntry] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["entity",b"entity"]) -> typing.Optional[typing_extensions.Literal["extern_entry","table_entry","action_profile_member","action_profile_group","meter_entry","direct_meter_entry","counter_entry","direct_counter_entry","packet_replication_engine_entry","value_set_entry","register_entry","digest_entry"]]: ...
...
class ExternEntry(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        extern_type_id: builtins.int = ...,
        extern_id: builtins.int = ...,
        entry: typing.Optional[google.protobuf.any_pb2.Any] = ...,
        ) -> None: ...
...
class TableEntry(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        table_id: builtins.int = ...,
        match: typing.Optional[typing.Iterable[global___FieldMatch]] = ...,
        action: typing.Optional[global___TableAction] = ...,
        priority: builtins.int = ...,
        controller_metadata: builtins.int = ...,
        meter_config: typing.Optional[global___MeterConfig] = ...,
        counter_data: typing.Optional[global___CounterData] = ...,
        meter_counter_data: typing.Optional[global___MeterCounterData] = ...,
        is_default_action: builtins.bool = ...,
        idle_timeout_ns: builtins.int = ...,
        time_since_last_hit: typing.Optional[global___TableEntry.IdleTimeout] = ...,
        metadata: builtins.bytes = ...,
        ) -> None: ...
...
class FieldMatch(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        field_id: builtins.int = ...,
        exact: typing.Optional[global___FieldMatch.Exact] = ...,
        ternary: typing.Optional[global___FieldMatch.Ternary] = ...,
        lpm: typing.Optional[global___FieldMatch.LPM] = ...,
        range: typing.Optional[global___FieldMatch.Range] = ...,
        optional: typing.Optional[global___FieldMatch.Optional] = ...,
        other: typing.Optional[google.protobuf.any_pb2.Any] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["field_match_type",b"field_match_type"]) -> typing.Optional[typing_extensions.Literal["exact","ternary","lpm","range","optional","other"]]: ...
...
class TableAction(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        action_profile_member_id: builtins.int = ...,
        action_profile_group_id: builtins.int = ...,
        action_profile_action_set: typing.Optional[global___ActionProfileActionSet] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type",b"type"]) -> typing.Optional[typing_extensions.Literal["action","action_profile_member_id","action_profile_group_id","action_profile_action_set"]]: ...
...
class ActionProfileActionSet(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        action_profile_actions: typing.Optional[typing.Iterable[global___ActionProfileAction]] = ...,
        ) -> None: ...
...
class ActionProfileAction(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["watch_kind",b"watch_kind"]) -> typing.Optional[typing_extensions.Literal["watch","watch_port"]]: ...
...
class ActionProfileGroup(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        action_profile_id: builtins.int = ...,
        group_id: builtins.int = ...,
        members: typing.Optional[typing.Iterable[global___ActionProfileGroup.Member]] = ...,
        max_size: builtins.int = ...,
        ) -> None: ...
...
class MeterEntry(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        config: typing.Optional[global___MeterConfig] = ...,
        counter_data: typing.Optional[global___MeterCounterData] = ...,
        ) -> None: ...
...
class CounterEntry(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        counter_id: builtins.int = ...,
        index: typing.Optional[global___Index] = ...,
        data: typing.Optional[global___CounterData] = ...,
        ) -> None: ...
...
class MeterCounterData(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        green: typing.Optional[global___CounterData] = ...,
        yellow: typing.Optional[global___CounterData] = ...,
        red: typing.Optional[global___CounterData] = ...,
        ) -> None: ...
...
class PacketReplicationEngineEntry(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        multicast_group_entry: typing.Optional[global___MulticastGroupEntry] = ...,
        clone_session_entry: typing.Optional[global___CloneSessionEntry] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type",b"type"]) -> typing.Optional[typing_extensions.Literal["multicast_group_entry","clone_session_entry"]]: ...
...
class MulticastGroupEntry(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        multicast_group_id: builtins.int = ...,
        replicas: typing.Optional[typing.Iterable[global___Replica]] = ...,
        ) -> None: ...
...
class ValueSetEntry(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        value_set_id: builtins.int = ...,
        members: typing.Optional[typing.Iterable[global___ValueSetMember]] = ...,
        ) -> None: ...
...
class RegisterEntry(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        register_id: builtins.int = ...,
        index: typing.Optional[global___Index] = ...,
        data: typing.Optional[p4.v1.p4data_pb2.P4Data] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["data",b"data","index",b"index"]) -> builtins.bool: ...
...
class DigestEntry(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        digest_id: builtins.int = ...,
        config: typing.Optional[global___DigestEntry.Config] = ...,
        ) -> None: ...
...
class StreamMessageRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        arbitration: typing.Optional[global___MasterArbitrationUpdate] = ...,
        packet: typing.Optional[global___PacketOut] = ...,
        digest_ack: typing.Optional[global___DigestListAck] = ...,
        other: typing.Optional[google.protobuf.any_pb2.Any] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["update",b"update"]) -> typing.Optional[typing_extensions.Literal["arbitration","packet","digest_ack","other"]]: ...
...
class PacketOut(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        payload: builtins.bytes = ...,
        metadata: typing.Optional[typing.Iterable[global___PacketMetadata]] = ...,
        ) -> None: ...
...
class StreamMessageResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        arbitration: typing.Optional[global___MasterArbitrationUpdate] = ...,
        packet: typing.Optional[global___PacketIn] = ...,
        digest: typing.Optional[global___DigestList] = ...,
        idle_timeout_notification: typing.Optional[global___IdleTimeoutNotification] = ...,
        other: typing.Optional[google.protobuf.any_pb2.Any] = ...,
        error: typing.Optional[global___StreamError] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["update",b"update"]) -> typing.Optional[typing_extensions.Literal["arbitration","packet","digest","idle_timeout_notification","other","error"]]: ...
...
class DigestList(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        digest_id: builtins.int = ...,
        list_id: builtins.int = ...,
        data: typing.Optional[typing.Iterable[p4.v1.p4data_pb2.P4Data]] = ...,
        timestamp: builtins.int = ...,
        ) -> None: ...
...
class IdleTimeoutNotification(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        table_entry: typing.Optional[typing.Iterable[global___TableEntry]] = ...,
        timestamp: builtins.int = ...,
        ) -> None: ...
...
class StreamError(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        space: typing.Text = ...,
        code: builtins.int = ...,
        packet_out: typing.Optional[global___PacketOutError] = ...,
        digest_list_ack: typing.Optional[global___DigestListAckError] = ...,
        other: typing.Optional[global___StreamOtherError] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["details",b"details"]) -> typing.Optional[typing_extensions.Literal["packet_out","digest_list_ack","other"]]: ...
...
class PacketOutError(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        packet_out: typing.Optional[global___PacketOut] = ...,
        ) -> None: ...
...
class DigestListAckError(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        digest_list_ack: typing.Optional[global___DigestListAck] = ...,
        ) -> None: ...
...
class SetForwardingPipelineConfigRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        election_id: typing.Optional[global___Uint128] = ...,
        action: global___SetForwardingPipelineConfigRequest.Action.ValueType = ...,
        config: typing.Optional[global___ForwardingPipelineConfig] = ...,
        ) -> None: ...
...
class ForwardingPipelineConfig(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        p4info: typing.Optional[p4.config.v1.p4info_pb2.P4Info] = ...,
        p4_device_config: builtins.bytes = ...,
        cookie: typing.Optional[global___ForwardingPipelineConfig.Cookie] = ...,
        ) -> None: ...
...
class CapabilitiesResponse(google.protobuf.message.Message):
    ...
    p4runtime_api_version: typing.Text
